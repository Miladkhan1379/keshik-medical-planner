const CACHE='keshikyar-1-1-mobile-v3';
const ASSETS=['./','./index.html','./styles.css','./mobile.css','./jalali.js','./holidays.js','./xlsx-lite.js','./solver.js','./app.js','./v11-extra.js','./extras.js','./mobile.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./sample_people.xlsx','./sample_schedule.xlsx'];
